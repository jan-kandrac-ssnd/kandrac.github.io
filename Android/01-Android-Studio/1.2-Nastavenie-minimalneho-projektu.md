...
> **Tip1**: Nezabudni, že ak v Android Studio niečo píšeš a vyskočí ti nejaký autocomplete, tak pomocou **ENTER** alebo
> **TAB** ho vieš akceptovať. Takéto akceptovanie autocomplete zároveň správne vyrieši aj importy

> **Tip2**: Ak si zabudol pridať import, nerob to manuálne! Nabehni kurzorom na kód, ktorý vyžaduje import (`Text`) a
> stlač **ALT + ENTER** <kbd>Ctrl</kbd>

### 2 Ak nedokážeš spustiť aplikáciu, ale v kóde nie sú chyby
